for (
  var colors = ["#ffbc00"],
    ...
    options = {
      ...
      series: [
        { name: "Desktops", data: [30, 41, 35, 51, 49, 62, 69, 91, 126] },
      ],
    ...
    colors = (chart.render(), ["#124d92", "#47ad77", "#fa5c7c", "#ffbc00"]),
        ...
        yaxis: [
          {
            ...
            label: {
              borderColor: "#47ad77",
              style: { color: "#fff", background: "#47ad77" },
              text: "Support",
            },
          },
        ],
