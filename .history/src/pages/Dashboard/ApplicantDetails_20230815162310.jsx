...
function ApplicantDetails() {
  ...
  const [listOfConcerns, setListOfConcerns] = React.useState([
  ...
  const handleMultiSelectConcernsChange = (newSelectedConcerns) => {
    console.log("Selected Concerns:", newSelectedConcerns);
     const arrayOfStrings = newSelectedConcerns.map((concernObject) => concernObject.concern);
     console.log(arrayOfStrings);
    setSelectedConcern(arrayOfStrings);
  };
...
4 unsuccessful */}
  ...
  onChange={handleMultiSelectConcernsChange}
