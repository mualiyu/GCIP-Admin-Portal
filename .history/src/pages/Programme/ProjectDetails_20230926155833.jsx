      ...
      <section
        ...
        <section className="project" style={{ width: "48%" }}>
          <div className="project_details">
            ...
            <section
              ...
              <div>
                <p className="details__name"> {projectDetail.coordinates} </p>
            ...
            <section
              ...
              <div>
                <p className="details__name"> {projectDetail.lgs} </p>
          ...
          <div className="project_assigned project_details">
            <p className="b-b">Assigned Project</p>
          </div>
        </section>
        <section className="maps" style={{ width: "48%" }}>
          <div
            ...
            id="map-canvas"
            style={{ minHeight: 400 }}>
            <p className="b-b">Location Coordinates</p>
          </div>
        </section>
      </section>
      {/* </section> */}
