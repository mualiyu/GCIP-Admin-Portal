...
export default function Tab2({ moveToTab }) {
  ...
  const handleSubmit = () => {
    const savedData = JSON.parse(localStorage.getItem("lotData")) || [];
    const newData = [...savedData, lotData];
    console.log(newData);
    localStorage.setItem("lotData", JSON.stringify(newData));
  };

  // useEffect(() => {
  //   const savedData = localStorage.getItem("lotData");
  //   console.log(savedData);
  //   if (savedData) {
  //     setLotData(JSON.parse(savedData));
  //   }
  // }, []);
