              ...
              <tbody>
                <>
                  ...
                  <tr>
                    ...
                    <td>
                      {
                        TextExtractor(current?.application_business_proposal[0]
              ...
              <tbody>
                <>
                  <tr key={current?.id}>
                    ...
                    <td>{TextExtractor(current?.application_company_info.profile)}</td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td style={{ width: 300 }}>
                    ...
                    <td>
                      {
                        TextExtractor(current?.application_company_info
                  ...
                  <tr>
                    ...
                    <td>
                      {TextExtractor(current?.application_company_info.short_term_objectives)}
                    </td>
                  </tr>
                  <tr>
                    <td>4</td>
                    ...
                    <td>
                      {TextExtractor(current?.application_company_info.medium_term_objectives)}
                    </td>
                  </tr>
                  <tr>
                    <td>5</td>
                    ...
                    <td>
                      {TextExtractor(current?.application_company_info.long_term_objectives)}
