...
export default function Submissions() {
  ...
  const downloadDocumentsInZip = async (id) => {
    console.log(id);
    ...
    try {
      ...
      link.href = url;
      link.download = 'document.pdf'; // Replace with the desired filename for the downloaded document
      link.click();
        ...
        <TableBody>
          {allSubmissions.map((applicant, index) => (
            ...
            >
              ...
              <TableCell> 
                <button style={{border: 'none', border: 'thin solid green', backgroundColor: 'white', color: 'green', marginRight: 4, padding: '9px 22px', cursor: 'pointer' }} disabled={buttonLoading[index]}  onClick={() => downloadDocumentsInZip(applicant.id)}>
