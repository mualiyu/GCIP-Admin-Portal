...
export default function Tab4({ moveToTab }) {
  ...
  const sendDataToServer = () => {
    ...
    const data = {
      program: {
        programName: "Name and title of the Program",
        programDescription: "<p>Description of program</p>",
        lots: [
          {
            name: "Net lot",
          },
        ...
        stages: [
          {
            ...
            document:
              "https://api.gcip.rea.gov.ng/storage/programFiles/Physem (500 x 100 px) (1)_1711909235.png",
          },
        ],
        uploads: [
          {
            name: "New document",
            file: "https://api.gcip.rea.gov.ng/storage/programFiles/Physem (500 x 100 px) (1)_1711909259.png",
          },
        ],
      },
    };
