...
!(function (a) {
  ...
  function t() {
    (this.$body = a("body")),
      (this.charts = []),
      (this.defaultColors = ["#124d92", "#47ad77", "#fa5c7c", "#ffbc00"]);
  }
  (t.prototype.interpolationExample = function () {
      ...
      t = new Chart(t, {
        ...
        data: {
          ...
          datasets: [
            ...
            { label: "Small Radius", data: a, borderColor: e[2], fill: !1 },
          ],
        },
        options: {
          responsive: !0,
    ...
    (t.prototype.multiAxesExample = function () {
      var t = document.getElementById("multi-axes-example"),
        e = t.getAttribute("data-colors"),
        e = e ? e.split(",") : this.defaultColors,
        t = t.getContext("2d"),
        t = new Chart(t, {
    ...
    (t.prototype.lineSegmentExample = function () {
      var t = document.getElementById("line-segment-example"),
        e = t.getAttribute("data-colors"),
        e = e ? e.split(",") : this.defaultColors,
        t = t.getContext("2d"),
        t = new Chart(t, {
            ...
            datasets: [
              {
                ...
                segment: {
                  borderColor: function (t) {
                    return (
                      skipped(t, "rgb(0,0,0,0.2)") || down(t, "rgb(192,75,75)")
                    );
                  },
                  borderDash: function (t) {
                    return skipped(t, [6, 6]);
                  },
                },
              },
            ],
    ...
    (t.prototype.steppedExample = function () {
      var t = document.getElementById("stepped-example"),
        e = t.getAttribute("data-colors"),
        e = e ? e.split(",") : this.defaultColors,
        t = t.getContext("2d"),
        t = new Chart(t, {
          ...
          options: {
            responsive: !0,
            maintainAspectRatio: !1,
            interaction: { intersect: !1, axis: "x" },
            plugins: { legend: { display: !1, position: "top" } },
            scales: {
              x: { grid: { display: !1 } },
              y: { grid: { display: !1 } },
