...
function Login() {
  ...
  const validationSchema = Yup.object({
    ...
    confirmPassword: Yup.string().min(6, "Passwords didn't match!").required(),
  });
                 ...
                 outlined
                  ...
                  <div className="mb-3">
                    <div className="form-check">
                      ...
                      />
                      <span className="text-muted" for="checkbox-signup">
                      I Agree to all <a>Terms of Use, Services </a>
                 <a> & Policies</a> of GCIP
                      </span>
                    </div>
                  </div>
