      ...
      >
                    ...
                    <td>
                      {applicant.isApproved == 1 &&
                        <button style={{border: 'none', marginRight: 4, padding: '9px 22px', cursor: 'pointer' }}  onClick={() => updateApplicantStatus(applicant.id, 3, index)}>
                          {buttonLoading[index] ? '<MoonLoader size={16}/>' : 'Revoke'}
                        </button>
                      }
                      {applicant.isApproved != 1
                       &&
