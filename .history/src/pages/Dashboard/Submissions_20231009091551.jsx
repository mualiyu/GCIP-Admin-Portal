...
export default function Submissions() {
  ...
  const url =
    submissionType === "prequalification"
      ? `/api/admin/program/applications/getAll?program_id=${programId}`
  ...
  const handleOptionChange = (selection) => {
    ...
    switch (selection) {
      ...
      case "all":
        setAllSubmissions(
          submitted.concat(unSuccessful, submitted, queried, review, successful)
        );
        break;
      case "queried":
      ...
      default:
        setAllSubmissions(
          submitted.concat(unSuccessful, submitted, review, queried, successful)
        );
        break;
    }
  };
