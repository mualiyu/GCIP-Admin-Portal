  ...
  return (
    <div className="review-container">
      ...
      <div style={{
                  ...
                  <sup> 
                    {applicationStatus == 1 ? 'Submitted': applicationStatus == 2 ? 'Queried' : applicationStatus == 3 ? 'Successful' : applicationStatus == 4 ? 'Unsuccessful' : 'Not Reviewed Yet'}
                  </sup>
...
<p>Status: {applicationStatus == 1 ? 'Submitted': applicationStatus == 2 ? 'Queried' : applicationStatus == 3 ? 'Successful' : 'Unsuccessful'}</p>
{/* 1 Submitted 
2 queried
3 successful
4 unsuccessful */}
