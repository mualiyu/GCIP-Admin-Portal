            ...
            <div className="flex my-xl">
              <div>
                <h4 class="header-title">
                  Applicants
                  <span style={{ color: 'white', backgroundColor: 'red', padding: '10px 15px', border-radius: '50%', fontSize: 12, marginLeft: 7 }}>
                    {allApplicants.length}
                  </span>
                </h4>
                <p class="text-muted fs-14">
                  The table below shows the list of all registered applicant
                  within the GCIP system.
                </p>
              </div>
              <FormControl
                sx={{ m: 1, minWidth: 300 }}
