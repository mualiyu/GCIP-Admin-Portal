        ...
        <TableBody>
          {allSubmissions.map((applicant, index) => (
            ...
            >
              ...
              <TableCell style={{ color: applicant?.applicant.isApproved == 1 ? '#aabf10' : applicant.applicant.isApproved == 2 ? 'green' : 'red',}} >
              {applicant?.applicant.isApproved == 1 ? "Pending" : applicant.applicant.isApproved == 2 ? "Approved" : "Declined"} 
              </TableCell>
