...
export default function Submissions() {
  ...
  const seeDetails = (applicantId) => {
    navigate(`/Home/Submissions/${programId}/applicant/${applicantId}`);
  };
            ...
            >
              ...
              <TableCell> 
                <button style={{border: 'none', border: 'thin solid green', backgroundColor: 'white', color: 'green', marginRight: 4, padding: '9px 22px', cursor: 'pointer' }} disabled={buttonLoading[rowIndex]}  onClick={() => downloadDocumentsInZip(applicant.id, applicant?.applicant?.name, rowIndex)}>
                        ...
                        <button style={{border: 'none', backgroundColor: '#006439', border: 'none', color: 'white', marginRight: 4, padding: '9px 22px', cursor: 'pointer' }} disabled={buttonLoading[rowIndex]}  onClick={() => seeDetails(applicant.id)}>
                         See More
                        </button>
                </TableCell>
