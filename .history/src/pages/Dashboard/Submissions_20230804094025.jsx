        ...
        <TableBody>
          {allSubmissions.map((applicant, rowIndex) => (
            ...
            >
              ...
              <TableCell> 
                <button style={{border: 'none', border: 'thin solid green', backgroundColor: 'white', color: 'green', marginRight: 4, padding: '9px 22px', cursor: 'pointer' }} disabled={buttonLoading[index]}  onClick={() => downloadDocumentsInZip(applicant.id, applicant?.applicant?.name, rowIndex)}>
