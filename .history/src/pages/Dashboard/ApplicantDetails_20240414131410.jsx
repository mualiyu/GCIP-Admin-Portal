                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#">
                        <div class="user-info">
                          Phone :{" "}
                          <span className="inffdgshd">{userInfo?.phone} </span>
                        </div>
                      </a>
                    </li>
                    <li>
          ...
          <div class="col-xxl-6 col-xl-6 col-lg-6" style={{ marginLeft: 5 }}>
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Application Eligibility</h4>
              </div>
              <div class="card-body">
                <div class="app-link">
                  <div class="card-header flex-row">
                    <h5> ** Company Possess Innovative Ideas</h5>
                    <a
                      class=""
                      href="#"
                  ...
                  <div class="card-header flex-row">
                    <h5>Company Require Assistance to Upscale</h5>
                    <a class="" href="#">
                      {
                        current?.application_eligibility
                  ...
                  <div class="card-header flex-row">
                    <h5>Extent Company Challenges Financial in Nature</h5>
                    <a class="" href="#">
                      {
                        current?.application_eligibility
                  ...
                  <div class="card-header flex-row">
                    <h5>Company has been in Existence For </h5>
                    <a class="" href="#">
                      {current?.application_eligibility.years_of_existence}
                    </a>
                  </div>

                  <div class="card-header flex-row">
                    <h5>Is Company a Nigerian Origin?</h5>
                    <a class="" href="#">
                      {current?.application_eligibility.nigerian_origin}
                    </a>
                  </div>
                </div>
              </div>
