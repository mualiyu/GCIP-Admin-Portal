              ...
              {allApplicants.map((applicant, index)=>(
                  <tr key={applicant.id} >
                    ...
                    <td>
                        ...
                        <button style={{border: 'none', padding: '9px 22px', cursor: 'pointer' }}  onClick={() => updateApplicantStatus(applicant.id, 2)}>
                        Approve
                        </button>

                        {applicant?.isApproved == 2 && 
                        <button style={{border: 'none', padding: '9px 22px', cursor: 'pointer' }}  onClick={() => updateApplicantStatus(applicant.id, 3)}>
                        Decline
                        </button>
                        }
                          {/* 1 Apporved
