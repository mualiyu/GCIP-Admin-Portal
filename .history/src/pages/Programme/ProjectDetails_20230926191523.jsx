...
function ProjectDetails({ latitude, longitude }) {
  ...
  const handleOptionChange = (e) => {
    const selectedRcNumber = e.target.value.applicant;
    // const selectedApplicantId = e.target.value;
    // const selectedRcNumber = e.target.getAttribute("applicant");
    console.log(selectedRcNumber);
  };
