                    ...
                    <li>
                      <a href="#">
                        <div class="user-info">
                          Application Status : &nbsp;
                          <span className="inffdgshd">
                            {current?.status == "1" ? "Submitted" : "Pending"}
                          </span>
                        </div>
                      </a>
                    </li>
          ...
          <div style={{ fontSize: 11, textAlign: "left" }}>
            ...
            <table
              ...
              <tbody>
                ...
                <tr>
                  <td>2</td>
                  <td> Company Has Benn in existence for</td>
              ...
              <tbody>
                {current.application_business_proposal.map((item, index) => {
                  return (
                    <tr key={item?.id}>
                      <td>{++index}</td>
                      <td>Have you acquired patency or authority of the patent owners to demonstrate the technology</td>
