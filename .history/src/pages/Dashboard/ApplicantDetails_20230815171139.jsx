...
function ApplicantDetails() {
  ...
  const handleMultiSelectConcernsChange = (listofConcernsxx) => {
    ...
    newConcerns.map((item)=>{
      // console.log(item.concern);
      // newArray.push(item.concern);
      setSelectedConcern(selectedConcern => [...selectedConcern, item.concern] )
    })
    console.log(selectedConcern);
    // const arrayOfStrings = newConcerns.map((concernObject) => concernObject.concern);
