        ...
        <div className="home_top col-12">
          ...
          <div>
            ...
            <p class="text-muted fs-14">
              The table below{" "}
              {allSubmissions.length > 0 ? "shows" : "will show"} the list of
              all Submitted Applications within the GCIP system for {programId}.
            </p>
          </div>

          <FormControl sx={{ m: 1, minWidth: 300 }} style={{ marginLeft: 20 }}>
                ...
                <tbody>
                  {allSubmissions?.map((applicant, rowIndex) => (
                    <tr key={applicant.applicant.id}>
                      ...
                      <td>
                        {applicant.applicant.email} <br />0
