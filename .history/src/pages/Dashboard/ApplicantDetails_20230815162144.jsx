...
function ApplicantDetails() {
  ...
  const handleMultiSelectConcernsChange = (listOfConcerns) => {
    console.log("Selected Concerns:", listOfConcerns);
     const arrayOfStrings = listOfConcerns.map((concernObject) => concernObject.concern);
