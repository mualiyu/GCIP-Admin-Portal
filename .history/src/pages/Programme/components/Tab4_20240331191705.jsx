...
export default function Tab4({ moveToTab }) {
  ...
  const sendDataToServer = () => {
      ...
      stages: [
        {
          ...
          endDate: "29/12/2025",
          description:
            "Sed placeat illum eum iste rerum aut culpa galisum non voluptas voluptatem. Ut voluptatem aperiam ea autem maiores et beatae sapiente. Vel minima consequuntur eos optio alias in sequi quia.",
          document:
            "http://127.0.0.1:8000/storage/programFiles/Testing (1)_1711113430.pdf",
        },
      ],
      uploads: [
        {
    ...
    let sendToServer = JSON.stringify(pro);
    console.log(sendToServer);
    console.log("send to server" + JSON.stringify(pro));
