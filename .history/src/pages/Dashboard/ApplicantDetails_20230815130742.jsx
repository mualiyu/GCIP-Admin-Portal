...
function ApplicantDetails() {
  ...
  const handleDecision = async () => {
    const newSelectedConcerns = [];
    const selectedConcerns = document.getElementById('#concernsList');
    selectedConcerns.map((sc, ind) => {
      newSelectedConcerns.push({
        concerns: sc.concern
      });
    });
    console.log(newSelectedConcerns)
